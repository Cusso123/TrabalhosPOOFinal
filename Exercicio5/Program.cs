////Exercício 09
//Crie uma classe chamada Biblioteca que representa uma biblioteca com uma Lista de Livros.  
//A classe Biblioteca deve ter os seguintes atributos (property): 
//-listaDeLivros que representa um lista vazia de livros 
//A classe Livro deve ter os seguintes atributos(property):  ISBN, NomeLivro, Autor (que será outra classe), Idioma, Edicao, DataLancamento.
//A classe Autor deve ter os seguintes atributos(property):  Nome, PaisOrigem, DataNascimento, IdiomaNativo
//A Biblioteca deve ter os seguintes métodos:
//-AdicionarLivro(livro: Livro) que recebe um Livro como parâmetro e adiciona o livro na lista de livros da Biblioteca.
//- RemoverLivro (ISBN:string) que recebe o ISBN como parâmetro e remove o livro da Lista 
//- ListarLivros () que não recebe Parâmetro e mostra todos os livros na tela.
//- ListarLivrosOrdemAlfabetica () que não recebe Parâmetro e mostra todos os livros na tela em ordem alfabética de título.
//- ListarLivroPorIdioma (idioma:string) que recebe o nome de um idioma e mostra na tela todos os livros do idioma passado com parâmetro.
//- ListarAutorLivroOutroIdioma () não recebe parâmetro e mostra na tela os autores e a quantidade de livros publicados em idiomas diferentes do idioma nativo do autor.
//Crie métodos diferentes dos listados acima😊
